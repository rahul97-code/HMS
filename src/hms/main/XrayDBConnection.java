...
public class XrayDBConnection {
	public Connection connect;
	public Statement statement;
	private String GetXrayDB_location;
	private static final String XrayDB_location = "X:/";
	private static final String XrayImages_location = "Y:/";
	
	public static void main(String[] args) {
		new XrayDBConnection();
		}

	public XrayDBConnection() {
    	readXrayFile();
        // Database connection parameters
        String dbURL = "jdbc:ucanaccess://"+GetXrayDB_location;
        String username = "";
        String password = "";
	...
	public void readXrayFile() {
		...
		try {
			...
			System.out.println("Xray_DB="+GetXrayDB_location);
