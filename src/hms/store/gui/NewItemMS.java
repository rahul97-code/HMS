...
public class NewItemMS extends JDialog {
...
//	NewBillForm newBillForm=null;
	...
	public static void main(String[] args) {
		try {
			NewItemMS dialog = new NewItemMS();
	...
	public NewItemMS() {
		setResizable(false);
		setTitle("Medical Store New Item");
...
//					if(newBillForm!=null)
//					{
//						newBillForm.searchItemTF.setText((itemNameSTR));
//					}
					if(newInvoice!=null)
					{
...
//	public void newBillInstatnce(NewBillForm newBillForm)
//	{
//		this.newBillForm=newBillForm;
//	}
