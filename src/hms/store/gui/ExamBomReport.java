...
public class ExamBomReport extends JDialog {
	...
	public static void main(String[] arg) {
		new ExamBomReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public ExamBomReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ExamBomReport.class.getResource("/icons/rotaryLogo.png")));
		setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		setBounds(400, 200, 950, 464);
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(ExamBomReport.this) == JFileChooser.APPROVE_OPTION) {
		...
		btnExcel.setBounds(20, 96, 147, 38);
		panel.add(btnExcel);
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
            ExamBomDBConnection db=new ExamBomDBConnection();
            ResultSet rs = db.retrieveData();
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(ExamBomReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
