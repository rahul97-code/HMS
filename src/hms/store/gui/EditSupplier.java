...
public class EditSupplier extends JDialog {
	...
	bankNameSTR,bankAcountSTR,streetSTR,citySTR,stateSTR,zipSTR,regionSTR;
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			EditSupplier dialog = new EditSupplier("1");
	...
	public EditSupplier(String id) {
		...
		JLabel lblPurchasePrice = new JLabel("Fiscal Code* :");
		...
		saveBT.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				stateSTR=stateTF.getText().toString();
				...
				if(companyNameSTR.equals("")||displayNameSTR.equals("")||mobileNOSTR.equals("")||streetSTR.equals("")||citySTR.equals("")||stateSTR.equals("")||regionSTR.equals(""))
				{
					...
					JOptionPane.showMessageDialog(null,
							"Supplier Updated Successfully", "Update Supplier",
		...
		stateTF.setFont(new Font("Tahoma", Font.PLAIN, 13));
		stateTF.setColumns(10);
		stateTF.setBounds(159, 95, 174, 25);
		panel_1.add(stateTF);
...
public void getSupplierDetail(String id) {
		...
		ResultSet resultSet = dbConnection.retrieveDetail(id);
		try {
			while (resultSet.next()) {
			
				
				companyNameTF.setText(resultSet.getObject(1).toString());
				displayNameTF.setText(resultSet.getObject(2).toString());
				mobileNoTF.setText(resultSet.getObject(3).toString());
				emailTF.setText(resultSet.getObject(4).toString());
				streetTF.setText(resultSet.getObject(5).toString());
				cityTF.setText(resultSet.getObject(6).toString());
				stateTF.setText(resultSet.getObject(7).toString());
				zipTF.setText(resultSet.getObject(8).toString());
				regionTF.setText(resultSet.getObject(9).toString());
				phoneTF.setText(resultSet.getObject(10).toString());
				faxTF.setText(resultSet.getObject(11).toString());
				fiscalCodeTF.setText(resultSet.getObject(12).toString());
				regNoTF.setText(resultSet.getObject(13).toString());
				taxIDTF.setText(resultSet.getObject(14).toString());
				managerNameTF.setText(resultSet.getObject(15).toString());
				bankNameTF.setText(resultSet.getObject(16).toString());
				bankAccountTF.setText(resultSet.getObject(17).toString());
			}
