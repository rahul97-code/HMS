...
import hms.patient.slippdf.Challan_PDF;
...
public class ChallanBrowser extends JDialog {
	...
	public static void main(String[] arg) {
		ChallanBrowser browser = new ChallanBrowser();
	 ...
	 * Create the frame.
	 */
	public ChallanBrowser() {
		setResizable(false);
		setTitle("Challan List");
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ChallanBrowser.class.getResource("/icons/rotaryLogo.png")));
...
//							.getValueAt(row, 6).toString();
		...
		btnNewButton.setIcon(new ImageIcon(ChallanBrowser.class
		...
		btnExcel.setIcon(new ImageIcon(ChallanBrowser.class
	...
	public void populateTable(String dateFrom, String dateTo) {
		try {
			...
			DefaultTableModel model = new DefaultTableModel(Rows_Object_Array,
					new String[] { "ID", "Challan No", "Vendor Name", "Date",
							"Time", "Total","Status" }) {
				@Override
			...
			Logger.getLogger(ChallanBrowser.class.getName()).log(Level.SEVERE, null,
					ex);
		}
	}
}
