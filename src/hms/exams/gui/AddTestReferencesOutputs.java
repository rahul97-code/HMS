...
public class AddTestReferencesOutputs extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AddTestReferencesOutputs dialog = new AddTestReferencesOutputs(
					"abc", "1");
	 ...
	 * Create the dialog.
	 */
	public AddTestReferencesOutputs(String examName, String examCode) {
		setTitle("Save Reference Ranges For Test");
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				AddTestReferencesOutputs.class
