...
public class ExamsBrowserIPD extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					ExamsBrowserIPD frame = new ExamsBrowserIPD();
	 ...
	 * Create the frame.
	 */
	public ExamsBrowserIPD() {
		setTitle("Exam Entry List");
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ExamsBrowserIPD.class.getResource("/icons/rotaryLogo.png")));
			...
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				  if (arg0.getClickCount() == 2) {
				         ...
				         ResultSet rs=amountReceiptDBConnection.retrieveAllRecieptNo(selectedObject+"");
				         try {
				        	 while(rs.next()){
...
//							}
		...
		btnNewButton_1.setIcon(new ImageIcon(ExamsBrowserIPD.class
		...
		btnNewButton_2.setIcon(new ImageIcon(ExamsBrowserIPD.class
				.getResource("/icons/zoom_r_button.png")));
		btnNewButton_2.setFont(new Font("Tahoma", Font.PLAIN, 12));

		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel.setIcon(new ImageIcon(ExamsBrowserIPD.class
	...
	public void populateTable(String dateFrom, String dateTo) {
		try {
			...
			ResultSet rs = db.retrieveAllDataNonPaid(dateFrom, dateTo);
			...
			DefaultTableModel model = new DefaultTableModel(Rows_Object_Array,
					new String[] { "Exam No.", "Patient ID", "Patient Name",
							"Doctor Name", "Exam Date", "Exam Name","Exam Charges",
							"Exam Code" }) {
				@Override
			...
			Logger.getLogger(ExamsBrowserIPD.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	}
