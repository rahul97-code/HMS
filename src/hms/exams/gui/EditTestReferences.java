...
public class EditTestReferences extends JDialog {
	...
	public static void main(String[] args) {
		try {
			EditTestReferences dialog = new EditTestReferences("abc","1");
	 ...
	 * Create the dialog.
	 */
	public EditTestReferences(String examName,String examCode) {
		setTitle("Save Reference Ranges For Test");
		setIconImage(Toolkit.getDefaultToolkit().getImage(EditTestReferences.class.getResource("/icons/rotaryLogo.png")));
