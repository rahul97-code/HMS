...
public class PatientTestHistory extends JPanel {
	...
	public PatientTestHistory() {  
		...
		panel.setBounds(346, 241, 303, 175);
		add(panel);
		panel.setLayout(null);

		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(6, 42, 287, 127);
					...
					if (!arg0.getValueIsAdjusting()) {
						...
						if (isWindows()) {
							...
							if (list.getSelectedValue().toString().endsWith(".pdf")
									...
									.endsWith(".bmp")
									|| list.getSelectedValue().toString()
									.endsWith(".BMP") || list.getSelectedValue().toString()
									.endsWith(".doc")) {
		...
		btnLisReport.setBounds(348, 209, 301, 25);
		add(btnLisReport);
	...
	public void populateTestHistoryTable(String patientID) {
		...
		try {
			...
			int NumberOfColumns = 3, NumberOfRows = 0;
