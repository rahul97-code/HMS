...
public class TokenEntry extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public TokenEntry(OPDBrowser opdBrowser) {
	...
	public void updateCounter() {
		...
		if(!connection.checkToken(ReceptionMain._id, textField.getText().toString(), "1"))
		{
		...
		dispose();
		OPDEntery opdEntery=new OPDEntery(browser);
