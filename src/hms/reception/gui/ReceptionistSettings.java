...
public class ReceptionistSettings extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ReceptionistSettings dialog = new ReceptionistSettings("ekta");
	 ...
	 * Create the dialog.
	 */
	public ReceptionistSettings(final String receptionistID) {
		setTitle("Change Password");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReceptionistSettings.class.getResource("/icons/rotaryLogo.png")));
		...
		ResultSet rs=db.retrievePassword(receptionistID);
		try {
			while (rs.next()) {
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						}else
						{
							ReceptionistDBConnection db=new ReceptionistDBConnection();
							try {
								db.updateDataPassword(receptionistID, newPass);
							} catch (Exception e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
								db.closeConnection();
