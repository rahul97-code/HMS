...
public class InvoiceItemsRegisterReport extends JDialog {
	...
	public static void main(String[] arg) {
		new InvoiceItemsRegisterReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public InvoiceItemsRegisterReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(InvoiceItemsRegisterReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(InvoiceItemsRegisterReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveAllInvoiceItems(dateFrom,dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(InvoiceItemsRegisterReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
