...
public class PatientOnBedReport extends JDialog {
	...
	public static void main(String[] arg) {
		new PatientOnBedReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public PatientOnBedReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(PatientOnBedReport.class.getResource("/icons/rotaryLogo.png")));
			...
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				  if (arg0.getClickCount() == 2) {
				         ...
				         Object selectedObject = jTable.getModel().getValueAt(row, 0);
				         
				     	PatientOnBedDetailsReport bedDetailsReport=new PatientOnBedDetailsReport(selectedObject.toString());
				     	bedDetailsReport.setModal(true);
				     	bedDetailsReport.setVisible(true);
				  }
			}
		});
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(PatientOnBedReport.this) == JFileChooser.APPROVE_OPTION) {
		...
		btnExcel.setBounds(16, 80, 147, 38);
		panel.add(btnExcel);
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrievePatientCount();
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(PatientOnBedReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
