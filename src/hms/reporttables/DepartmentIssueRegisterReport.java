...
public class DepartmentIssueRegisterReport extends JDialog {
	...
	public static void main(String[] arg) {
		new DepartmentIssueRegisterReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public DepartmentIssueRegisterReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DepartmentIssueRegisterReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(DepartmentIssueRegisterReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveAllIssuedRegister(dateFrom,dateTo);
