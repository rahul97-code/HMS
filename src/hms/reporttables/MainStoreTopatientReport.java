...
public class MainStoreTopatientReport extends JDialog {
	...
	public static void main(String[] arg) {
		new MainStoreTopatientReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public MainStoreTopatientReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainStoreTopatientReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(MainStoreTopatientReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveAllIssuedPatientPills(dateFrom,dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(MainStoreTopatientReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
