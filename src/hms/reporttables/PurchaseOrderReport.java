...
public class PurchaseOrderReport extends JDialog {
	...
	public static void main(String[] arg) {
		new PurchaseOrderReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public PurchaseOrderReport() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(PurchaseOrderReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(PurchaseOrderReport.this) == JFileChooser.APPROVE_OPTION) {
		...
		btnExcel.setBounds(16, 87, 147, 38);
		panel.add(btnExcel);
		populateTable1();
	}
	...
	public void populateTable1()
	{
		...
		try {
			...
			ResultSet rs = db.retrievePurcahseOrder2();
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(PurchaseOrderReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
