...
public class ItemConsumedReport extends JDialog {
	...
	public static void main(String[] arg) {
		new ItemConsumedReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public ItemConsumedReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ItemConsumedReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(ItemConsumedReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveConsumables(dateFrom, dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(ItemConsumedReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
