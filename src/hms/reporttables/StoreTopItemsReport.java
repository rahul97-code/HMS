...
public class StoreTopItemsReport extends JDialog {
	...
	public static void main(String[] arg) {
		new StoreTopItemsReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public StoreTopItemsReport() {
		setResizable(false);
		setTitle("Main Store Top 20 Items Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(StoreTopItemsReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(StoreTopItemsReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveTopItems(dateFrom, dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(StoreTopItemsReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
