...
public class PatientOnBedDetailsReport extends JDialog {
	...
	public static void main(String[] arg) {
		new PatientOnBedDetailsReport("").setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public PatientOnBedDetailsReport(String wardNameSTR) {
		setResizable(false);
		setTitle("Report");
		wardName=wardNameSTR;
		setIconImage(Toolkit.getDefaultToolkit().getImage(PatientOnBedDetailsReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(PatientOnBedDetailsReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1()
	{
		...
		try {
			...
			ResultSet rs = db.retrieveGetDetail(wardName);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(PatientOnBedDetailsReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
