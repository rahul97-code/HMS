...
public class ExamsDoneReport extends JDialog {
	...
	public static void main(String[] arg) {
		new ExamsDoneReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public ExamsDoneReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ExamsDoneReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(ExamsDoneReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveAllDoneitems(dateFrom, dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(ExamsDoneReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
