...
public class ExamsReport extends JDialog {
	...
	public static void main(String[] arg) {
		new ExamsReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public ExamsReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ExamsReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(ExamsReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(ExamsReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
