...
public class PatientHistoryRailway extends JDialog {
	...
	ImageIcon opdHistoryIcon = new ImageIcon(
			PatientHistoryRailway.class.getResource("/icons/users.png"));
	ImageIcon testHistoryIcon = new ImageIcon(
			PatientHistoryRailway.class.getResource("/icons/list_button.png"));
	...
	public static void main(String[] args) {
		...
		PatientHistoryRailway frame = new PatientHistoryRailway();
	 ...
	 * Create the frame.
	 */
	public PatientHistoryRailway() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				PatientHistoryRailway.class.getResource("/icons/rotaryLogo.png")));
		setTitle("Railway Bill Format");
		...
		searchBT.setIcon(new ImageIcon(PatientHistoryRailway.class
 ...
 * searchPatientTB.getDocument().addDocumentListener(
		...
		billNumberTF.setText("RACGH/Railway/");
		...
		patientNameTF.setBounds(423, 191, 202, 25);
		...
		lblPatientName_1.setBounds(323, 196, 97, 14);
		...
		admissionDC.setBounds(424, 131, 201, 20);
		panel_4.add(admissionDC);
		
		JLabel lblDateOfDischarge = new JLabel("Date of Discharge");
		lblDateOfDischarge.setBounds(322, 162, 90, 20);
		panel_4.add(lblDateOfDischarge);
		...
		dischargeDC.setBounds(424, 162, 201, 20);
		panel_4.add(dischargeDC);
		
		JLabel lblDoctorName = new JLabel("Doctor Name :");
		lblDoctorName.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblDoctorName.setBounds(322, 440, 97, 14);
		...
		doctorNameTF.setBounds(422, 435, 202, 25);
		panel_4.add(doctorNameTF);
		btnAllData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(p_id.equals(""))
				{
					...
					try {
						new PatientsRaiwayDataBill(hm,p_id,dateFromSTR,dateToSTR);
