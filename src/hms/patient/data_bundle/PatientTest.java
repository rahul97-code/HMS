...
public class PatientTest extends JPanel {
	...
	public PatientTest() {
		...
		scrollPane.setBounds(20, 17, 316, 396);
		add(scrollPane);
		readFile();
		widal.add("O");
		widal.add("H");
	...
	public void populateTestHistoryTable(String patientID,String dateFrom,String dateTo) {
		p_id = patientID;
		fileList.clear();
		list.setListData(fileList);
		progressBar.setValue(0);
		try {
			...
			ResultSet rs = db.retrieveTestHistoryDataPatientIDDate(patientID,dateFrom,dateTo);
			...
			rs = db.retrieveTestHistoryDataPatientIDDate(patientID,dateFrom,dateTo);
