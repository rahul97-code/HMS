...
public class AccountsSettings extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AccountsSettings dialog = new AccountsSettings("ekta");
	 ...
	 * Create the dialog.
	 */
	public AccountsSettings(final String receptionistID) {
		setTitle("Change Password");
		setIconImage(Toolkit.getDefaultToolkit().getImage(AccountsSettings.class.getResource("/icons/rotaryLogo.png")));
