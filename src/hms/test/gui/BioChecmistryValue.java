...
public class BioChecmistryValue extends JDialog {
	...
	String exam_counter = "0", examname_id = "0", 
	 ...
	 * Create the dialog.
	 */
	public BioChecmistryValue(String p_name, final String exam_id,
			final String exam_name,final String examName_id) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(BioChecmistryValue.class.getResource("/icons/rotaryLogo.png")));
