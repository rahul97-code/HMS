...
public class TestHistory extends JDialog {
	...
	ImageIcon opdHistoryIcon = new ImageIcon(
			TestHistory.class.getResource("/icons/users.png"));
	ImageIcon testHistoryIcon = new ImageIcon(
			TestHistory.class.getResource("/icons/list_button.png"));
	...
	public static void main(String[] args) {
		...
		TestHistory frame = new TestHistory("sukhpal","9");
	 ...
	 * Create the frame.
	 */
	public TestHistory(String patient_id,String labNumber) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				TestHistory.class.getResource("/icons/rotaryLogo.png")));
		setTitle("Patient Test History");
		 testHistory = new TestHistoryData(labNumber);
		...
		searchBT.setIcon(new ImageIcon(TestHistory.class
