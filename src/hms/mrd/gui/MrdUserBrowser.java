...
public class MrdUserBrowser extends JDialog {

	private JPanel contentPane;
	private JTable mrdBrowserTable;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					MrdUserBrowser frame = new MrdUserBrowser();
	 ...
	 * Create the frame.
	 */
	public MrdUserBrowser() {
		setResizable(false);
		setTitle("Mrd User Entry List");
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				MrdUserBrowser.class.getResource("/icons/rotaryLogo.png")));
		...
		mrdBrowserTable = new JTable();
		mrdBrowserTable.setFont(new Font("Tahoma", Font.PLAIN, 12));
		mrdBrowserTable.getTableHeader().setReorderingAllowed(false);
		mrdBrowserTable
				.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
		mrdBrowserTable.setModel(new DefaultTableModel(new Object[][] { {
				null, null, null, null, null }, }, new String[] { "User ID.",
				"User Name", "Telephone No.", "Address" }));
		mrdBrowserTable.getColumnModel().getColumn(0).setMinWidth(75);
		mrdBrowserTable.getColumnModel().getColumn(1).setPreferredWidth(150);
		mrdBrowserTable.getColumnModel().getColumn(1).setMinWidth(120);
		mrdBrowserTable.getColumnModel().getColumn(2).setPreferredWidth(150);
		mrdBrowserTable.getColumnModel().getColumn(2).setMinWidth(130);
		mrdBrowserTable.getColumnModel().getColumn(3).setMinWidth(75);
		mrdBrowserTable.getColumnModel().getColumn(3).setPreferredWidth(150);
		
		mrdBrowserTable.getSelectionModel().addListSelectionListener(
				new ListSelectionListener() {
					@Override
					public void valueChanged(ListSelectionEvent e) {
						// TODO Auto-generated method stub
						selectedRowIndex = mrdBrowserTable.getSelectedRow();
						selectedRowIndex = mrdBrowserTable
								.convertRowIndexToModel(selectedRowIndex);
						int selectedColumnIndex = mrdBrowserTable
								.getSelectedColumn();
						btnEditDoctor.setEnabled(true);
						btnDelete.setEnabled(true);
					}
				});
		scrollPane.setViewportView(mrdBrowserTable);
		...
		btnNewButton.setIcon(new ImageIcon(MrdUserBrowser.class
		...
		btnNewButton_1.setIcon(new ImageIcon(MrdUserBrowser.class
	...
	public void populateTable1() {
		try {
			...
			btnEditDoctor.setEnabled(false);
			btnDelete.setEnabled(false);
			mrdBrowserTable.setModel(model);
			mrdBrowserTable.getColumnModel().getColumn(0).setMinWidth(75);
			mrdBrowserTable.getColumnModel().getColumn(1).setPreferredWidth(150);
			mrdBrowserTable.getColumnModel().getColumn(1).setMinWidth(120);
			mrdBrowserTable.getColumnModel().getColumn(2).setPreferredWidth(150);
			...
			Logger.getLogger(MrdUserBrowser.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	}
