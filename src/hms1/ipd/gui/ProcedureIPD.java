...
public class ProcedureIPD extends JDialog {
	 ...
	 * Create the frame.
	 */
	public ProcedureIPD(final ProcedureIpdBrowser procedureIpdBrowser) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ProcedureIPD.class.getResource("/icons/rotaryLogo.png")));
		setTitle("Procedure IPD Entry");
		setModal(true);
		...
		panel_4.setBorder(new TitledBorder(UIManager
				.getBorder("TitledBorder.border"), "Procedure IPD Entry Form",
...
//					patientIDCB.setModel(patientID);
		...
		searchBT.setIcon(new ImageIcon(ProcedureIPD.class
		...
		panel.setBounds(695, 91, 313, 344);
		panel_4.add(panel);
...
//		SchemeTB.setColumns(10);
		...
		claim_idtxt.setEnabled(false);
		claim_idtxt.setBounds(106, 310, 201, 25);
...
//				 else if ((claim_idtxt.getText().equals("") && insuranceTypeTB.getText().toString().equals("ECHS")) || (claim_idtxt.getText().equals("") && insuranceTypeTB.getText().toString().equals("CGHS")) || (claim_idtxt.getText().equals("") && insuranceTypeTB.getText().toString().equals("Railway"))) {
//						JOptionPane.showMessageDialog(null,
...
//					}
					...
					try {
						new IPDSlipPdfRegenrate(insertedID + "","2");
					...
					dispose();
					if (procedureIpdBrowser != null)
						procedureIpdBrowser.populateTable(
								""
										+ DateFormatChange
												.StringToMysqlDate(new Date()),
								""
		...
		btnNewButton_4.setIcon(new ImageIcon(ProcedureIPD.class
...
//					SchemeTB.setText(p_scheme);
		...
		panel_3.setBounds(695, 447, 313, 118);
		panel_4.add(panel_3);
...
//				newPatient.IPDEnteryObject(EmergencyIpd.this);
		...
		btnNewButton.setIcon(new ImageIcon(ProcedureIPD.class
...
//		panel_7.add(label);
	...
	public void getPatientsID(String index) {
		...
		try {
			...
			if(insuranceTypeTB.getText().equals("ECHS") || insuranceTypeTB.getText().equals("Railway")|| insuranceTypeTB.getText().equals("CGHS"))
			{
