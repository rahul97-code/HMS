...
public class DialysisIPD extends JDialog {
	...
	private JRadioButton rdbtnCashless;
	 ...
	 new DialysisIPD(null).setVisible(true);
	 }
	 ...
	 * Create the frame.
	 */
	public DialysisIPD(final DialysisIpdBrowser dialysisIpdBrowser) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				DialysisIPD.class.getResource("/icons/rotaryLogo.png")));
		setTitle("Dialysis IPD Entry");
		setModal(true);
		...
		panel_4.setBorder(new TitledBorder(UIManager
				.getBorder("TitledBorder.border"), "Dialysis IPD Entry Form",
...
//					patientIDCB.setModel(patientID);
		...
		searchBT.setIcon(new ImageIcon(DialysisIPD.class
		...
		panel.setBounds(695, 91, 313, 341);
		panel_4.add(panel);
...
//		SchemeTB.setColumns(10);
		...
		claim_idtxt.setEnabled(false);
		claim_idtxt.setBounds(106, 309, 201, 25);
		...
		lblClaimId.setBounds(16, 309, 70, 15);
...
//					}
					...
					try {
						new IPDSlipPdfRegenrate(insertedID + "","3");
					...
					dispose();
					if (dialysisIpdBrowser != null)
						dialysisIpdBrowser.populateTable(
								""
										+ DateFormatChange
												.StringToMysqlDate(new Date()),
								""
		...
		btnNewButton_4.setIcon(new ImageIcon(DialysisIPD.class
...
//					SchemeTB.setText(p_scheme);
		...
		panel_3.setBounds(695, 444, 313, 118);
		panel_4.add(panel_3);
...
//				newPatient.IPDEnteryObject(EmergencyIpd.this);
		...
		btnNewButton.setIcon(new ImageIcon(DialysisIPD.class
...
//			"Yes"}));
		...
		rdbtnCashless.setBounds(202, 164, 100, 23);
