...
public class EmergencyIpdBrowser extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					EmergencyIpdBrowser frame = new EmergencyIpdBrowser();
	 ...
	 * Create the frame.
	 */
	public EmergencyIpdBrowser() {
		setResizable(false);
		setTitle("Emergency IPD Entry List");
		setIconImage(Toolkit.getDefaultToolkit().getImage(EmergencyIpdBrowser.class.getResource("/icons/rotaryLogo.png")));
    			...
    			public void mouseClicked(MouseEvent arg0) {
    				...
    				if (arg0.getClickCount() == 2) {
    					...
    					selectedIpdId = ipdbrowserTable.getModel().getValueAt(row, 0)
    							.toString();
    					try {
							new IPDSlipPdfRegenrate(selectedIpdId,"1");
...
//    							.getValueAt(row, 6).toString();
		...
		JButton btnNewButton = new JButton("Emergency IPD");
		btnNewButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				EmergencyIpd ipdEntery=new EmergencyIpd(EmergencyIpdBrowser.this);
...
//		        internal.toFront();
		...
		btnNewButton.setIcon(new ImageIcon(EmergencyIpdBrowser.class.getResource("/icons/Business.png")));
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnNewButton.setBounds(4, 440, 140, 35);
		...
		btnNewButton_1.setBounds(817, 440, 139, 35);
		...
		btnNewButton_2.setIcon(new ImageIcon(EmergencyIpdBrowser.class.getResource("/icons/zoom_r_button.png")));
...
//				deposit.setVisible(true);
				 IPDDBConnection db=new IPDDBConnection();
		           try {
					db.updateDataEmergency(selectedIpdId);
					  JOptionPane.showMessageDialog(null,
								"Converted to IPD.", "Converted Ipd",
		...
		btnIpdBill.setBounds(164, 440, 110, 35);
...
//	
		...
		btnChangeDoctor.setBounds(463, 440, 123, 35);
		contentPane.add(btnChangeDoctor);
		JButton btnReturnDiposite1 = new JButton("Return / Deposit");
		btnReturnDiposite1.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				IPDDeposit deposit=new IPDDeposit();
				deposit.setVisible(true);
...
//		btnReturnDiposite1.setVisible(false);
		btnReturnDiposite1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnReturnDiposite1.setBounds(309, 440, 123, 35);
		contentPane.add(btnReturnDiposite1);
		if(ReceptionMain.receptionShift.equals("1")){
			btnReturnDiposite1.setEnabled(true);
		}else{
			btnReturnDiposite1.setEnabled(false);
		}
		...
		btnChangeBed.setBounds(714, 440, 99, 35);
		...
		btnAddPackage.setBounds(589, 440, 123, 35);
	...
	public void populateTable(String dateFrom,String dateTo)
	{
		try {
            IPDDBConnection db=new IPDDBConnection();
            ResultSet rs = db.retrieveAllDataEmergency(dateFrom, dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            rs = db.retrieveAllDataEmergency(dateFrom, dateTo);
...
//    							.toString();
//    					try {
//							new IPDSlipPdfRegenrate(selectedIpdId);
//						} catch (DocumentException | IOException e) {
//							// TODO Auto-generated catch block
//							e.printStackTrace();
//						}
...
//    		});
            ...
            Logger.getLogger(EmergencyIpdBrowser.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
}
