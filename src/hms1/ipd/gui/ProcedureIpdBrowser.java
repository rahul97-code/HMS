...
public class ProcedureIpdBrowser extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					ProcedureIpdBrowser frame = new ProcedureIpdBrowser();
	 ...
	 * Create the frame.
	 */
	public ProcedureIpdBrowser() {
		setResizable(false);
		setTitle("Procedure IPD Entry List");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ProcedureIpdBrowser.class.getResource("/icons/rotaryLogo.png")));
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (arg0.getClickCount() == 2) {
					...
					selectedIpdId = ipdbrowserTable.getModel().getValueAt(row, 0)
							.toString();
					try {
						new IPDSlipPdfRegenrate(selectedIpdId,"2");
...
//							.getValueAt(row, 6).toString();
		...
		JButton btnNewButton = new JButton("Procedure IPD");
		btnNewButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				ProcedureIPD ipdEntery=new ProcedureIPD(ProcedureIpdBrowser.this);
...
//		        internal.toFront();
		...
		btnNewButton.setIcon(new ImageIcon(ProcedureIpdBrowser.class.getResource("/icons/Business.png")));
...
//		btnIpdBill.setVisible(false);
		...
		btnNewButton_2.setIcon(new ImageIcon(ProcedureIpdBrowser.class.getResource("/icons/zoom_r_button.png")));
		btnNewButton_2.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel.setIcon(new ImageIcon(ProcedureIpdBrowser.class.getResource("/icons/ipdbed.gif")));
		lblNewLabel.setBounds(10, 332, 172, 75);
		panel.add(lblNewLabel);
		
		JButton btnNewButton_3 = new JButton("Edit Ayushman Reg.");
		...
		btnNewButton_3.setBounds(21, 298, 146, 23);
...
//		
	...
	public void populateTable(String dateFrom,String dateTo)
	{
		try {
            ...
            ResultSet rs = db.retrieveAllDataProcedure(dateFrom, dateTo);
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            rs = db.retrieveAllDataProcedure(dateFrom, dateTo);
    		...
    		ipdbrowserTable.getColumnModel().getColumn(8).setMinWidth(130);
   
        } catch (SQLException ex) {
            Logger.getLogger(ProcedureIpdBrowser.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
}
