...
public class DoctorReport extends JDialog {
	 ...
	 * Create the frame.
	 */
	public DoctorReport(final IPDBrowser ipdBrowser) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				DoctorReport.class.getResource("/icons/rotaryLogo.png")));
		...
		searchBT.setIcon(new ImageIcon(DoctorReport.class
		...
		panel.setBounds(695, 91, 313, 314);
		panel_4.add(panel);
...
//					}
		...
		btnNewButton_4.setIcon(new ImageIcon(DoctorReport.class
...
//					SchemeTB.setText(p_scheme);
		...
		panel_3.setBounds(695, 406, 313, 118);
		panel_4.add(panel_3);
...
//				newPatient.IPDEnteryObject(DoctorReport.this);
//				newPatient.setVisible(true);
			}
		});
		btnNewButton.setIcon(new ImageIcon(DoctorReport.class
