...
public class rotate implements PdfPCellEvent {
 
    /** The resulting PDF. */
    public static final String RESULT1 = "D:/text_fields.pdf";
    /** The resulting PDF. */
    public static final String RESULT2 = "D:/text_filled.pdf";
    ...
    public void manipulatePdf(String src, String dest) throws IOException, DocumentException {
        ...
        form.setFieldProperty("text_3", "clrfflags", BaseField.PASSWORD, null);
    ...
    public void createPdf(String filename) throws DocumentException, IOException {
        ...
        table.addCell("Name:");
        cell = new PdfPCell();
        cell.setCellEvent(new rotate(1));
        table.addCell(cell);
 
        table.addCell("Loginname:");
        cell = new PdfPCell();
        cell.setCellEvent(new rotate(2));
        table.addCell(cell);
 
        table.addCell("Password:");
        cell = new PdfPCell();
        cell.setCellEvent(new rotate(3));
        table.addCell(cell);
 
        table.addCell("Reason:");
        cell = new PdfPCell();
        cell.setCellEvent(new rotate(4));
	...
	public void cellLayout(PdfPCell cell, Rectangle rectangle, PdfContentByte[] canvases) {
        ...
        case 1:
            ...
            text.setOptions(BaseField.REQUIRED);
            break;
        case 2:
            text.setMaxCharacterLength(8);
            text.setOptions(BaseField.COMB);
        ...
        case 3:
            ...
            text.setOptions(BaseField.PASSWORD);
            text.setVisibility(BaseField.VISIBLE_BUT_DOES_NOT_PRINT);
            break;
        case 4:
            ...
            text.setOptions(BaseField.MULTILINE | BaseField.REQUIRED);
            break;
        }
        try {
