...
public class word {
	...
	{
		try {
			String filename = "C:/Users/Sukhpal/Desktop/NewExcelFile.xls";
			HSSFWorkbook workbook = new HSSFWorkbook();
			HSSFSheet sheet = workbook.createSheet("OPD");
			opdAmount("2013-04-24", "2015-04-24", sheet);
			
			HSSFSheet sheet1 = workbook.createSheet("CARDS");
			cardAmount("2013-04-24", "2015-04-24", sheet1);
			
			HSSFSheet sheet2 = workbook.createSheet("MISC");
			miscAmount("2013-04-24", "2015-04-24", sheet2);
		
			try {
				HSSFSheet sheet3 = workbook.createSheet("EXAMS");
				examAmount("2014-04-24", "2015-04-24", sheet3);
			} catch (Exception e) {
				System.out.print(e+"");
			}
			HSSFSheet sheet4 = workbook.createSheet("ADVANCE-RETURN");
			Advance("2013-04-24", "2015-04-24", sheet4);
			
			HSSFSheet sheet5 = workbook.createSheet("INDOOR DISCHARGE");
			indoorAmount("2013-04-24", "2015-04-24", sheet5);
			
			HSSFSheet sheet6 = workbook.createSheet("Exam Reciepts");
			examAmountReciepts("2013-04-24", "2015-04-24", sheet6);
